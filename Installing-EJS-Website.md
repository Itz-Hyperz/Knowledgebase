...
Then, lets set a password for your new MySQL Server! Make sure to change the all lowercase word `'password'` to YOUR password.
...
Now create a SSL certificate through Certbot. Change `example.com` to your domain. Do not include `https://`.
